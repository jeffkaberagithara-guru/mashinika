...
const standardSteps = (
  ...
  { title: "We confirm the right fix", detail: "An expert confirms scope and price before any work begins." },
  { title: "Done, with a record", detail: "Work is completed safely and added to your vehicle's service history." },
]

const emergencySteps: ServiceStep[] = [
  { title: "Press for help", detail: "Select the problem and confirm your location — no typing required." },
  { title: "Nearest tech dispatched", detail: "A vetted technician accepts and heads to you with live tracking." },
  { title: "Back on the road", detail: "Pay safely on completion. Every job lands on your service record." },
]
...
export const services: ServiceDefinition[] = [
  {
    ...
    blurb: "Battery, tyre, fuel, keys and breakdown help — dispatched from the nearest available technician.",
    description:
  ...
  },
  {
    ...
    blurb: "Breakdown, battery, tyre, fuel and keys — sorted by a technician who is already near you.",
    description:
  ...
  },
  {
    ...
    blurb: "Professional fault diagnosis at your doorstep, with a clear written report before any work is done.",
    description:
    ...
    steps: standardSteps("Tell us the symptoms and pick a slot — a diagnostic tech comes to your vehicle."),
  ...
  },
  {
    ...
    blurb: "Flatbed recovery from anywhere, tracked live, straight to the workshop you choose.",
    description:
    ...
    steps: [
      { title: "Confirm where you are", detail: "Share your location and where the vehicle needs to go." },
      { title: "Flatbed dispatched", detail: "A nearby truck heads to you with live tracking." },
      { title: "Delivered, safely", detail: "Your vehicle is loaded with care and dropped at your chosen workshop." },
    ],
  ...
  },
  {
    ...
    blurb: "Pre-purchase and condition inspections with a detailed report you can trust.",
    description:
    ...
    steps: standardSteps("Pick the car, and an inspector meets you at the seller's location."),
  ...
  },
  {
    ...
    blurb: "Know exactly what you're buying, selling or driving — from certified inspectors.",
    description:
    ...
    steps: standardSteps("Book a slot and an inspector attends the vehicle wherever it is."),
    ctaLabel: "Book an inspection",
    ctaHref: "/request",
  },
  {
    ...
    blurb: "Valuation and negotiation support so you buy the right car at the right price.",
    description:
    ...
    steps: standardSteps("Tell us the car you're considering and we start the due-diligence pack."),
  ...
  },
  {
    ...
    blurb: "Valuation, due diligence and guidance for your biggest vehicle decision.",
    description:
    ...
    steps: standardSteps("Share the listing and our advisors prepare your buying pack."),
  ...
  },
  {
    ...
    steps: standardSteps("Tell us what your car needs and we build a schedule around you."),
  ...
  },
  {
    ...
    blurb: "Valuation, trade-in and vehicle swapping for when it's time to move on.",
    description:
    ...
    steps: standardSteps("Get your vehicle valued, then choose trade-in, swap or sale."),
  ...
  },
  {
    ...
    blurb: "Maintenance schedules, service history and supervision for business fleets.",
    description:
    ...
    steps: standardSteps("Register your fleet and we onboard your vehicles and drivers."),
  ...
  },
  {
    ...
    steps: standardSteps("Describe the job and a qualified mechanic comes to your vehicle."),
