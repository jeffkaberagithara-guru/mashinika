        ...
        <section className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-4 pt-14 pb-20 sm:px-6 lg:grid-cols-12 lg:items-center lg:gap-8 lg:px-8 lg:pt-20 lg:pb-28">
          <div className="lg:col-span-7">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-muted-foreground max-w-lg text-lg leading-relaxed">
                Press once and the nearest skilled technician comes to you — for
                a breakdown, a dead battery, a tow, or a second opinion. No
                typing, no phone tag.
              </p>
          ...
          <div className="lg:col-span-5">
            <div className="border-border bg-card rounded-xl border p-5 shadow-sm">
              ...
              <Timeline mutedBehindActive className="pt-5" items={howItWorks} />
            </div>
          </div>
        </section>
